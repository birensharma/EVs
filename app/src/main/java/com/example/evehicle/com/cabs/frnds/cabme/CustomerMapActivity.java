...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CustomerMapActivity.this, MainActivityRide.class);
            ...
            public void onClick(View v) {
                ...
                if (requestBol){
                   endRide();
                    ...
                    pickupMarker = mMap.addMarker(new MarkerOptions().position(pickupLocation).title("Pickup Here").icon(BitmapDescriptorFactory.fromResource(R.mipmap.pin)));
        ...
        mSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CustomerMapActivity.this, CustomerSettingsAcivity.class);
                startActivity(intent);
                return;
            }
        });
        ...
        driverLocationRefListner = driverLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()&& requestBol){
                    ...
                    if(distance<100){
                        mRequest.setText("Your Cab is Here...");
                    }
                    else{
    ...
    private void endRide(){
        ...
        mDriverCar.setText("");
        mDriverProfileImage.setImageResource(R.mipmap.ic_default);
